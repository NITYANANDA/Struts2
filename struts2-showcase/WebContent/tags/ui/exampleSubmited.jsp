			...
			<div class="span12">
				<table
					...
					<tr>
						...
						<td><s:date name="wakeup" format="hh:mm aa" /></td>
					</tr>
					...
					<s:label label="Favourite Vehical Specific"
						name="favouriteVehicalSpecific" />
					<tr>
						<td><label class="label">Favourite Cartoon Characters
								(Left):</label></td>
