		...
		<div class="row-fluid">
			<div class="span12">
				...
				<s:form action="exampleSubmit" enctype="multipart/form-data"
					...
					<sx:datetimepicker tooltip="Enter the time you wake up"
						label="Wake up time" name="wakeup" type="time" />

					<s:textarea tooltip="Enter your Biography" label="Biography"
						name="bio" cols="20" rows="3" />

					<s:select tooltip="Choose Your Favourite Color"
						label="Favorite Color" list="{'Red', 'Blue', 'Green'}"
						name="favouriteColor" emptyOption="true" headerKey="None"
						headerValue="None" />

					<s:select tooltip="Choose Your Favourite Language"
						label="Favourite Language" list="favouriteLanguages"
						name="favouriteLanguage" listKey="key" listValue="description"
						listCssStyle="style" emptyOption="true" headerKey="None"
						headerValue="None" />
					...
					<s:checkbox tooltip="Confirmed that your are Over 18"
						label="Age 18+" name="legalAge" />
					...
					<s:doubleselect tooltip="Choose your Vehical"
						label="Favourite Vehical" name="favouriteVehicalType"
						list="vehicalTypeList" listKey="key" listValue="description"
						value="'MotorcycleKey'" doubleValue="'YamahaKey'"
						doubleList="vehicalSpecificList" doubleListKey="key"
					...
					<s:reset cssClass="btn btn-danger"
						onclick="alert('Resetting form now... Press OK to continue!');" />
				</s:form>
			</div>
		</div>
	</div>
