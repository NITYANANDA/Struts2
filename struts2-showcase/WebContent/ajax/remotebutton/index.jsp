...
<body>
	...
	<br />
	<br /> A submit button, that highlights (blue color) its targets
	<sx:submit type="submit" value="submit" targets="t1" href="%{ajaxTest}"
		highlightColor="green" />

	<br />
	<br /> A submit button, with an indicator
	<img id="indicator"
	...
	<br />
	<br /> A submit button, with "notifyTopics"
	<sx:submit type="submit" value="submit" targets="t1" href="%{ajaxTest}"
		notifyTopics="/alltopics" />

	<br />
	<br /> Use an image as submit
	<s:url value="/images/struts-power.gif" var="imgUrl" />
	<sx:submit type="image" label="Alt Text" targets="t1" src="%{imgUrl}"
		href="%{ajaxTest}" />
	<br />
	<br />
	...
	<br />
	<br /> Use a button as submit (custom text)
	<s:form id="form" action="AjaxTest">
		<input type=textbox name="data">
		<sx:submit type="button" label="Update Content" targets="t1"
			id="ajaxbtn" />
	</s:form>
