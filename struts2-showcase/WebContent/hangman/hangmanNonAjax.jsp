	...
	<div class="row-fluid">
		...
		<table>
		  ...
		  <tr>
		    ...
		    <s:if test="%{hangman.gameEnded()}">
				<s:iterator var="currentCharacter" value="%{hangman.vocab.inCharacters()}" status="">
			...
			<s:else>
			    ...
			    <s:iterator var="currentCharacter" value="%{hangman.vocab.inCharacters()}" status="">
			        <s:if test="%{hangman.characterGuessedBefore(#currentCharacter)}" >
		  ...
		  <tr>
			...
			<s:else>
				<s:iterator var="currentCharacter" value="%{hangman.charactersAvailable}" status="">
			      ...
			      <s:a href="%{#url}" id="%{#currentCharacter}">
