		...
		<div class="row-fluid">
			<div class="span12">
				...
				<script>
						...
						updateCharacterAvailable : function(sourceId) {
							dojo.io
									.bind({
										...
										load : function(type, data, event) {
											var div = dojo
													.byId("updateCharacterAvailableDiv");
											destroyWidgets();
											div.innerHTML = data;
											...
											try {
												...
												var frag = xmlParser
														.parseElement(div,
																null, true);
												dojo.widget.getParser()
														.createComponents(frag);
												...
												alert('dojo error ' + e);
												dojo
														.debug("auto-build-widgets error: "
																+ e);
											}
										},
										mimetype : "text/html"
					...
					dojo.event.topic.subscribe("topicGuessMade", _listeners,
							"guessMade");
				</script>

				<table bgcolor="green">
					<tr>
						<td><s:url id="url" value="/hangman/images/hangman.png" /> <img
							alt="Hangman" src="<s:property value="%{#url}" />" width="197"
						...
						<td width="70" align="right">
							...
							<div id="updateGuessLeftDiv">
								...
								<img alt="No. Guesses Left" src="<s:property value="%{#url}"/>"
									width="20" height="20" border="0" />
							</div>
						</td>
						<td><s:url id="url" value="/hangman/images/guesses-left.png" />
							<img alt="Guesses Left" src="<s:property value="%{#url}" />"
						...
						<td width="330">
							...
							<div id="updateCharacterAvailableDiv">
								<s:iterator var="currentCharacter"
									...
									<s:url id="blankUrl" value="ajax/blank.action"
										includeContext="false" />
									<sx:a id="%{#currentCharacter}"
										beforeNotifyTopics="topicGuessMade"
										showErrorTransportText="true">
										<img height="36" alt=""
											src="<s:property value="%{#chalkboardImageUrl}" />"
											width="36" border="0" />
									</sx:a>
								</s:iterator>
							</div>
