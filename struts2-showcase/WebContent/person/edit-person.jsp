		...
		<div class="row-fluid">
			<div class="span3">
				<ul class="nav nav-tabs nav-stacked">
					...
					<s:url id="newpersonurl" action="new-person" namespace="/person"
						method="input" />
					...
					<table
						...
						<s:iterator var="p" value="persons">
							<tr>
								...
								<td><s:textfield label="First Name"
										name="persons(%{id}).name" value="%{name}" theme="simple" />
								</td>
								<td><s:textfield label="Last Name"
										name="persons(%{id}).lastName" value="%{lastName}"
										theme="simple" /></td>
							</tr>
						</s:iterator>
