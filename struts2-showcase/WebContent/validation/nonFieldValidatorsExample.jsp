...
<html>
<head>
<title>Struts2 Showcase - Validation - Non Field Validator
	Example</title>
<s:head />
</head>
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
				...
				<s:form method="POST" action="submitNonFieldValidatorsExamples"
					namespace="/validation">
					<s:textfield name="someText" label="Some Text" />
					<s:textfield name="someTextRetype" label="Retype Some Text" />
					<s:textfield name="someTextRetypeAgain"
						label="Retype Some Text Again" />
