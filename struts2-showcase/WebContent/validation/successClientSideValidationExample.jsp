<%--
    ...
    @author tm_jee
    @version $Date: 2012-10-19 20:49:39 +0200 (Fri, 19 Oct 2012) $ $Id: successClientSideValidationExample.jsp 1400220 2012-10-19 18:49:39Z jogep $
--%>

<%@taglib prefix="s" uri="/struts-tags"%>
<html>
<head>
<title>Struts2 Showcase - Validation - Success Client Side
	Validators Example</title>
<s:head />
</head>
<body>
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<table
					...
					<tr>
						<td>Regex Validator Field: <s:property
								value="regexValidatorField" /></td>
						<td>Field Expression Validator Field: <s:property
								value="fieldExpressionValidatorField" /></td>
					</tr>
				</table>
