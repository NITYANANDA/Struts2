<%--
   ...
   @author tm_jee
   @version $Date: 2012-10-19 20:49:39 +0200 (Fri, 19 Oct 2012) $ $Id: clientSideValidationExample.jsp 1400220 2012-10-19 18:49:39Z jogep $
--%>
...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12">
			...
			<s:form action="submitClientSideValidationExample.action" method="POST" validate="true">
