	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
				...
				<p>
					<b>Example 3:</b> This example illustrates a situation where you
					can transfer money from one account to another. We use the token to
					prevent double posts so the transfer only happens once. This
					example uses the token session based interceptor and redirect after
					post.
				<p />
				...
				<p>
					...
					<br />Balance of destination account:
