/*
 * $Id: TokenAction.java 1400220 2012-10-19 18:49:39Z jogep $
 *
...
/**
 * Example to illustrate the <code>token</code> and <code>tokenSession</code>
 * interceptor.
 */
public class TokenAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		Integer balSource = (Integer) ActionContext.getContext().getSession()
				.get("balanceSource");
		Integer balDest = (Integer) ActionContext.getContext().getSession()
		...
		ActionContext.getContext().getSession()
				.put("balanceDestination", newDest);
	...
	public String input() throws Exception {
		...
		if (balDest == null) {
			...
			ActionContext.getContext().getSession()
					.put("balanceDestination", balDest);
		}
