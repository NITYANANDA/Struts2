/*
 * $Id: StandardTagsAction.java 1400220 2012-10-19 18:49:39Z jogep $
 *
...
public class StandardTagsAction extends ActionSupport implements Preparable {
	...
	public void prepare() {
		...
		name = StandardTagsAction.class.getName().substring(
				StandardTagsAction.class.getName().lastIndexOf(".") + 1);
