/*
 * $Id: UITagExample.java 1400220 2012-10-19 18:49:39Z jogep $
 *
...
import org.apache.struts2.showcase.UITagExample.Language;
import org.apache.struts2.showcase.UITagExample.VehicalSpecific;
import org.apache.struts2.showcase.UITagExample.VehicalType;
...
public class UITagExample extends ActionSupport implements Validateable {
	...
	List<Language> favouriteLanguages = new ArrayList<Language>();
	List<VehicalType> vehicalTypeList = new ArrayList<VehicalType>();
	Map<VehicalType, List<VehicalSpecific>> vehicalSpecificMap = new HashMap<VehicalType, List<VehicalSpecific>>();
	...
	public UITagExample() {
		...
		List<VehicalSpecific> cars = new ArrayList<VehicalSpecific>();
		...
		List<VehicalSpecific> motorcycles = new ArrayList<VehicalSpecific>();
	...
	public List<VehicalType> getVehicalTypeList() {
	...
	public List<Language> getFavouriteLanguages() {
